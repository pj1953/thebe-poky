...
SYSROOTS=/opt/poky/1.6.1/sysroots
...
GLIBC=../build/tmp/work/armv5te-poky-linux-gnueabi/glibc/2.20-r0/package
cp $GLIBC/usr/bin/getent sysroots/$TARGETROOT/usr/bin

OPENSSH=../build/./tmp/work/armv5te-poky-linux-gnueabi/openssh/6.6p1-r0/package
